...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
   ...
   private static final int[] BUCKETS = {5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 75, 100, 200, 1000};
                ...
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        if (!(item.getTitle()== null) && !(item.getSnippet() == null)) {
                            ...
                            markerOptions.title(item.getTitle());
                        }else if(!(item.getResourceId() == -1)){
                            markerOptions.icon(BitmapDescriptorFactory.fromResource(item.getResourceId()));
                            //markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_map_icon));
                        }
