...
public class CustomSpAdapterStrength2 extends BaseAdapter {
    ...
    public CustomSpAdapterStrength2(ArrayList<JobTitle> arrayList, int view, EditBasicInfoFragment fragment, IndiEditProfileActivity activity) {
...
//fragment.spValue2 != -1 &&fragment.spValue3 != -1 && 
        if (fragment.spStrength3 == position |fragment.spStrength1 == position) {
