...
public class CustomSpAdapterStrength1 extends BaseAdapter {
    ...
    public CustomSpAdapterStrength1(ArrayList<JobTitle> arrayList, int view, EditBasicInfoFragment fragment, IndiEditProfileActivity activity) {
...
//fragment.spValue2 != -1 &&fragment.spValue3 != -1 && 
        if (fragment.spStrength2 == position |fragment.spStrength3 == position) {
