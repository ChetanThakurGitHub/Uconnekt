...
public class Strength3SpAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_sp_strength3, parent, false);
    ...
    public View getDropDownView(int i, View view, @NonNull ViewGroup viewGroup) {
        if (fragment.spStrength1 != -1 &&fragment.spStrength2 != -1 && fragment.spStrength1 == i |fragment.spStrength2 == i) {
        ...
        if (view == null || view.getTag().equals("Extra")) {
            ...
            view = inflater.inflate(R.layout.custom_sp_strength3, viewGroup, false);
            view.setTag("");
        }
