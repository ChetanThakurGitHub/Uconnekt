...
public class Strength2SpAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<JobTitle> arrayList;
    private EditBasicInfoFragment fragment;

    public Strength2SpAdapter(Context context, ArrayList<JobTitle> arrayList, EditBasicInfoFragment fragment) {
    ...
    public View getDropDownView(int i, View view, @NonNull ViewGroup viewGroup) {
        if (fragment.spStrength1 != -1 &&fragment.spStrength3 != -1 && fragment.spStrength1 == i |fragment.spStrength3 == i) {
        ...
        if (view == null || view.getTag().equals("Extra")) {
            ...
            view = inflater.inflate(R.layout.custom_sp_strength2, viewGroup, false);
            view.setTag("");
        }
