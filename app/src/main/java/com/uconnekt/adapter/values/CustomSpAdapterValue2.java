...
public class CustomSpAdapterValue2 extends BaseAdapter {
    ...
    public CustomSpAdapterValue2(ArrayList<JobTitle> arrayList, int view, EditBasicInfoFragment fragment, IndiEditProfileActivity activity) {
    ...
    public View getView(final int position, View row, ViewGroup parent) {
        ...
        ViewHolder holder;
//fragment.spValue1 != -1  &&fragment.spValue3 != -1 &&
        if ( fragment.spValue1 == position |fragment.spValue3 == position) {
