...
public class CustomSpAdapterValue3 extends BaseAdapter {
    ...
    public CustomSpAdapterValue3(ArrayList<JobTitle> arrayList, int view, EditBasicInfoFragment fragment, IndiEditProfileActivity activity) {
    ...
    public View getView(final int position, View row, ViewGroup parent) {
        ...
        ViewHolder holder;
//fragment.spValue1 != -1 &&fragment.spValue2 != -1 &&
        if ( fragment.spValue1 == position |fragment.spValue2 == position) {
