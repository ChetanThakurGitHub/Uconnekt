...
public class Value1SpAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_sp_value1, parent, false);
    ...
    public View getDropDownView(int i, View view, @NonNull ViewGroup viewGroup) {
       ...
       /* if(fragment instanceof EditBasicInfoFragment){
        ...
        if (view == null || view.getTag().equals("Extra")) {
            ...
            view = inflater.inflate(R.layout.custom_sp_value1, viewGroup, false);
            view.setTag("");
        }
