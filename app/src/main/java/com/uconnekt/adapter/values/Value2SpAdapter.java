...
public class Value2SpAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<JobTitle> arrayList;
    private EditBasicInfoFragment fragment;

    public Value2SpAdapter(Context context, ArrayList<JobTitle> arrayList, EditBasicInfoFragment fragment) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_sp_value2, parent, false);
    ...
    public View getDropDownView(int i, View view, @NonNull ViewGroup viewGroup) {
        if (fragment.spValue1 != -1 &&fragment.spValue3 != -1 && fragment.spValue1 == i |fragment.spValue3 == i) {
        ...
        if (view == null || view.getTag().equals("Extra")) {
            ...
            view = inflater.inflate(R.layout.custom_sp_value2, viewGroup, false);
            view.setTag("");
        }
