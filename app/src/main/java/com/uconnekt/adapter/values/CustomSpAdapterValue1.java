...
public class CustomSpAdapterValue1 extends BaseAdapter {
    ...
    public CustomSpAdapterValue1(ArrayList<JobTitle> arrayList, int view, EditBasicInfoFragment fragment, IndiEditProfileActivity activity) {
...
//fragment.spValue2 != -1 &&fragment.spValue3 != -1 &&
        if (fragment.spValue2 == position |fragment.spValue3 == position) {
