...
import com.uconnekt.resume_picker.adapters.FileAdapterListener;
import com.uconnekt.resume_picker.adapters.PhotoGridAdapter;
import com.uconnekt.resume_picker.cursors.loadercallbacks.FileResultCallback;
import com.uconnekt.resume_picker.models.Media;
import com.uconnekt.resume_picker.models.PhotoDirectory;
import com.uconnekt.resume_picker.utils.AndroidLifecycleUtils;
import com.uconnekt.resume_picker.utils.ImageCaptureManager;
import com.uconnekt.resume_picker.utils.MediaStoreHelper;
import com.uconnekt.resume_picker.view.FilePickerConst;
import com.uconnekt.resume_picker.view.PickerManager;
...
public class MediaDetailPickerFragment extends BaseFragment2 implements FileAdapterListener {
    ...
    public void onItemSelected() {
        ...
        if(photoGridAdapter!=null && selectAllItem!=null) {
            if (photoGridAdapter.getItemCount() == photoGridAdapter.getSelectedItemCount()) {
                selectAllItem.setIcon(R.drawable.ic_checked);
            ...
            if (photoGridAdapter != null) {
                ...
                if(selectAllItem!=null)
                    if(selectAllItem.isChecked()) {
                        ...
                        selectAllItem.setIcon(R.drawable.ic_uncheck);
                    }
                    else {
                        photoGridAdapter.selectAll();
