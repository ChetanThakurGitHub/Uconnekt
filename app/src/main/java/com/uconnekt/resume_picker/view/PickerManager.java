package com.uconnekt.resume_picker.view;
...
public class PickerManager {
  ...
  private int theme = R.style.MyCustomTheme;
...
/*  public ArrayList<String> getSelectedFilePaths(ArrayList<BaseFile> files) {
  ...
  public void addDocTypes() {
    String[] pdfs = { "pdf" };
    fileTypes.add(new FileType(FilePickerConst.PDF, pdfs, R.drawable.ic_attach));

    String[] docs = { "doc", "docx", "dot", "dotx" };
    fileTypes.add(new FileType(FilePickerConst.DOC, docs, R.drawable.ic_attach));

    String[] ppts = { "ppt", "pptx" };
    fileTypes.add(new FileType(FilePickerConst.PPT, ppts, R.drawable.ic_attach));

    String[] xlss = { "xls", "xlsx" };
    fileTypes.add(new FileType(FilePickerConst.XLS, xlss, R.drawable.ic_attach));

    String[] txts = { "txt" };
    fileTypes.add(new FileType(FilePickerConst.TXT, txts, R.drawable.ic_attach));
  }
